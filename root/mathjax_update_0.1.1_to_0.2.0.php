 ...
 * 
 * This file can only be used for updating to 0.2.0
 * For installing/uninstalling v0.2.0 or superior use mathjax_install.php
 * 
...
$filename = 'mathjax_update_0.1.1_to_0.2.0';
...
$versions = array(
	'0.2.0' => array(
		...
		'config_add' => array(
			...
			array('mathjax_mod_version', '0.2.0'),
		),
...
function math_bbcodes($action, $version)
{
	...
	{
		trigger_error('Please use mathjax_install.php<br>This file is just for the update between v0.1.1 to v0.2.0', E_USER_WARNING);
	}
}
